...
Usage:
    ...
    python main.py --part stream-demo   #   stream demo only (this will create and 
                                            train model as well if it isn't found)
"""
...
def main():
    """
    Parses arguments, loads dataset, performs desired tasks
    """
